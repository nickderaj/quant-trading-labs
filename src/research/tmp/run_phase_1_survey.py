...
SOURCES = [
    # ------------------------------------------------------------------ Tier 1
    {
        ...
        "hypotheses": [
            {
                "h": "d",
                "direction": "supports",
                "note": "returns 26% lower out-of-sample, 58% lower post-publication - consistent with arbitrage/efficiency eroding published edges",
            },
            {
                "h": "c",
                "direction": "supports",
                "note": "the *upper bound* on pure statistical-bias decay is only ~15% and not significantly different from zero - most decay is real capital chasing the anomaly, not an artifact of an overly strict re-test bar",
            },
        ],
        ...
        "red_flags": [],
        "testable_with_repo_data": {
            "testable": False,
            "how": "Methodological finding about the equity-factor literature generally; not a strategy to re-run on this repo's crypto/commodity data.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                ...
                "note": "argues the finance literature's own historical bar (t>2.0) is too LOOSE, not too strict - the opposite direction from 'our bar is too strict'; if anything this is evidence for tightening, not loosening",
            },
            {
                "h": "d",
                "direction": "supports",
                "note": "most of a large factor zoo is plausibly false discovery once corrected for the true number of trials",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "A statistical-methodology reference, not a strategy.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "a",
                "direction": "supports",
                "note": "over 80% of factors remain significant once construction is made consistent/implementable - i.e. HOW a factor is engineered (not just which factor) materially changes whether it survives",
            },
            {
                "h": "d",
                "direction": "contradicts",
                "note": "finds much less decay than the 'replication crisis' narrative implies once construction choices are standardized - a genuine tension with McLean-Pontiff's more pessimistic reading, reported as a conflict rather than averaged away",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "Equity cross-country factor library; no equity data of any kind exists in this repo.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "c",
                "direction": "neutral",
                "note": "defines the exact correction this repo uses; does not itself say what probability threshold ('>0.95') should be treated as a pass - that threshold choice is this repo's own convention, not something the source paper prescribes",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "Already implemented and used throughout this repo (notebooks 3, 7, 8).",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "c",
                "direction": "neutral",
                "note": "reinforces that DSR/PSR-style corrections are standard practitioner tooling for judging a Sharpe ratio's credibility, not an eccentric academic-only bar",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "Confirms an existing methodology choice; nothing new to test.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "e",
                "direction": "supports",
                "note": "hedge funds' gross US Treasury exposure (driven substantially by the cash-futures basis trade) doubled to $4.0tn (2023-Sep 2025) - real, large-scale money is made in structural basis trades this repo has never touched",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "Requires repo-market financing data and Treasury cash-bond data this repo has none of; also enormously capital/leverage-dependent.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "e",
                "direction": "supports",
                "note": "documents the basis trade as a real, scaled, structural (mechanical) source of return - exactly the 'P&L from a structural source rather than predicting direction' category sec 1 says this repo has never tested",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "Needs repo/funding-rate data, Treasury cash-bond prices, and leveraged margin access this repo has none of - explicitly infrastructure this repo lacks.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "e",
                "direction": "supports",
                "note": "the trade's stability is more sensitive to intermediation (dealer balance sheet) capacity than to funding-rate level per se - a capacity/infrastructure-first story, reinforcing that this category's edge is inseparable from access most retail-scale researchers don't have",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "Same infrastructure gap as the other basis-trade sources above.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "e",
                "direction": "supports",
                "note": "a regulator-convened committee treating this as a live systemic-risk topic underlines both the trade's real scale and its inseparability from leverage/margin infrastructure",
            },
        ],
    ...
    },
    {
        ...
        "hypotheses": [
            {
                "h": "e",
                "direction": "supports",
                "note": "a structural/mean-reversion mechanism (co-integrated pairs) genuinely survived transaction costs historically - a category this repo has never tested at all",
            },
            {
                "h": "d",
                "direction": "supports",
                "note": "the same category's modern-era decay (see Zhu 2024 below) is consistent with the efficiency/arbitraged-away story once a strategy is well known",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": True,
            "how": "This repo has no equities, but the same co-integration mechanism is directly testable on the 16-commodity panel's related products (e.g. CL-BZ, GC-SI) and the 30 pre-built spread series never yet backtested - flagged in the Phase 3 shortlist below.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "d",
                "direction": "supports",
                "note": "the original mechanical GGR method no longer delivers robust profits - a well-known strategy decaying is exactly the efficiency/arbitraged-away story",
            },
            {
                "h": "e",
                "direction": "partially supports",
                "note": "more adaptive, model-driven implementations reportedly still work - the mechanism isn't dead, the naive textbook version is, echoing hypothesis (a) as much as (e)",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": True,
            "how": "Same as the GGR entry above - directly testable on this repo's commodity spread data.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "b",
                "direction": "neutral",
                "note": "cost/impact scales with sqrt(volume/ADV), roughly independent of instrument/venue - a genuine, quantitative alternative cost model this repo's flat-bps assumption doesn't use, but it needs an ADV/participation-rate input this repo's cost model has never estimated",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "This repo's crypto/commodity data has no participation-rate or ADV-relative order-size information to calibrate sqrt-impact against; the existing flat bps+tick model is a coarser but not obviously wrong substitute at the position sizes implied by this repo's backtests.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "e",
                "direction": "supports",
                "note": "formalizes that a strategy's realistic capacity (not just its unconstrained Sharpe) is a first-order determinant of whether it is fundable/tradeable at all - directly relevant to filtering the Phase 3 shortlist",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "A framework, not a specific strategy; informs how the shortlist should be assessed rather than being itself testable.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "e",
                "direction": "supports",
                "note": "gives the formal mechanism by which market-making earns the spread while managing inventory risk - a structural P&L source this repo has never tested, exactly sec 1's 'never tested at all' list",
            },
        ],
        ...
        "red_flags": [
            "Secondary application note (Stanford course project) tiered down mentally from the primary 2008 paper - the specific numeric results in the course report itself should not be treated as Tier 1."
        ],
        "testable_with_repo_data": {
            "testable": False,
            "how": "Requires L2/LOB (order book) data and colocated/low-latency execution this repo has never had - explicitly not testable here.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "d",
                "direction": "supports",
                "note": "reports Bitcoin daily returns consistent with weak-form efficiency (variance ratios near 1, random walk not rejected)",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "A market-efficiency finding, not itself a strategy.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "d",
                "direction": "partially supports",
                "note": "efficiency is time-varying around major events, i.e. mostly efficient but with event-driven windows of inefficiency this repo's daily-bar, non-event-conditioned strategies would not be positioned to exploit anyway",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "Event-study design this repo's daily-bar crypto data could technically support, but not attempted here - filed as a hypothesis-generation note rather than a shortlist candidate given its narrow, single-event scope.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "d",
                "direction": "supports",
                "note": "establishes the pre-financialization commodity risk-premium baseline against which this repo's own post-2010 carry/momentum nulls (notebook 8) should be read as consistent with a decayed, financialized regime rather than a surprising failure",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "Historical/context paper; this repo's own sample (2010+) is already inside the post-financialization regime the paper's own follow-on literature describes.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "a",
                "direction": "supports",
                "note": "scaling equity momentum by inverse trailing realized vol nearly doubles its Sharpe ratio (0.53 -> 0.97) and slashes crash risk (excess kurtosis 18.24 -> 2.68) - a quantified, specific version of 'the textbook factor and the implemented factor are not the same thing'",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": True,
            "how": "This repo's own commodity carry/momentum (notebook 8) used constant, not vol-scaled, position sizing - a vol-scaled re-run of the existing carry/momentum signals is directly buildable from data already in this repo, flagged as a shortlist candidate below.",
        },
    },
    {
        ...
        "testable_with_repo_data": {
            "testable": True,
            "how": "Directly contradicts the naive read of the Barroso-Santa-Clara source for THIS repo's specific asset classes (commodities/crypto, not equities) - an important caution recorded before any vol-scaling probe is proposed.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "b",
                "direction": "contradicts",
                "note": "full-sample all-in implementation costs for momentum are estimated at 7.2-7.6%/yr, considerably LARGER than bid-ask-spread-only estimates, and large enough to eliminate most 1970-2016 momentum profit - evidence that realistic costs are often materially HIGHER than naive assumptions, the opposite direction from 'our cost model is too pessimistic'",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "Equity-anomaly cost estimates specifically; not directly transferable to crypto/commodity cost assumptions, but the general lesson (naive cost estimates often UNDERSTATE true cost) argues against loosening this repo's own cost model.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "b",
                "direction": "contradicts",
                "note": "reinforces that published (in-sample, often cost-light) anomaly returns systematically overstate what a real trader could capture net of realistic costs - again arguing this repo's cost assumptions are unlikely to be the too-harsh direction of error",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "Equity-anomaly specific; directional lesson only for this repo's own cost-model calibration.",
        },
    },
    # ------------------------------------------------------------------ Tier 2
    {
        ...
        "hypotheses": [
            {
                "h": "c",
                "direction": "supports",
                "note": "explicit skepticism of very high Sharpe claims ('why do you think you're better than Medallion') and framing a 0.5 information-ratio edge over a good existing strategy as already ambitious - directly informs what 'a real result' looks like at the top of the industry",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "An expert opinion informing Phase 2's bar recommendation, not a testable strategy.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "a",
                "direction": "supports",
                "note": "time-series momentum, applied consistently across 67 markets/4 asset classes over 137 years, is the kind of broad, engineered, multi-market implementation this repo's notebook 8 tested only as a single-lookback, single-asset-class (commodities-only), 15-year-sample version of",
            },
        ],
        ...
        "red_flags": [
            "Published by a firm that sells the exact strategy described - a conflict of interest, not a disqualifier, but reason for the Tier 2 (not 1) placement."
        ],
        "testable_with_repo_data": {
            "testable": True,
            "how": "This repo's notebook 8 Gate AM already tested a narrower version (commodities-only, 4 single lookbacks, no cross-asset blending) and found it sign-inconsistent - the multi-lookback BLEND (not any single lookback) is the specific, not-yet-tested variant this source suggests.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "a",
                "direction": "supports",
                "note": "practitioner CTA construction blends signals and asset classes in ways textbook single-factor backtests (like this repo's own) do not",
            },
        ],
        ...
        "red_flags": [
            "Same commercial-interest caveat as the century-of-evidence AQR paper."
        ],
        "testable_with_repo_data": {
            "testable": False,
            "how": "Descriptive/explanatory paper, not a specific testable construction beyond what's already covered by the century-of-evidence entry.",
        },
    },
    {
        ...
        "red_flags": [
            "Sourced via a secondary substack/PDF summary rather than Man Group's own primary factsheet for the specific 0.86 figure - flagged as a secondary-sourcing caveat even though Man AHL itself is unambiguously a real, identifiable institution."
        ],
        "testable_with_repo_data": {
            "testable": False,
            "how": "A benchmark data point for Phase 2's bar discussion, not a strategy to re-run.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "d",
                "direction": "neutral",
                "note": "summarizes the Tier 1 finding without adding independent evidence; used here only as a secondary confirmation, not counted toward hyp (d)'s Tier 1/2 support independently of the primary paper",
            },
        ],
    ...
    },
    {
        ...
        "hypotheses": [
            {
                "h": "b",
                "direction": "partially supports",
                "note": "reports well-built strategies degrading only 10-20% backtest-to-live, suggesting cost/execution modelling gaps are a real but secondary factor next to genuine signal decay",
            },
            {
                "h": "c",
                "direction": "supports",
                "note": "Sharpe degradation of 1/3 to 1/2 out-of-sample is presented as NORMAL and EXPECTED for a genuinely real strategy, not a sign the strategy was fake - relevant context for reading notebook 8's carry near-miss",
            },
            {
                "h": "d",
                "direction": "supports",
                "note": "R^2 < 0.25 for predicting a strategy's OOS performance from its own backtest stats underscores how weakly a backtest alone should be trusted",
            },
        ],
        ...
        "red_flags": [
            "Quantpedia's core business is selling a strategy database/subscription - a Tier 3/4-adjacent commercial model - but this specific meta-analysis content is about honestly reporting decay (the opposite of the marketing failure mode sec 3.1 warns about), which is why it is tiered 2 rather than 3/4."
        ],
        "testable_with_repo_data": {
            "testable": False,
            "how": "A meta-analysis of the general decay phenomenon, directly informing how Phase 2 should read this repo's own OOS results, not a specific strategy.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "e",
                "direction": "partially supports",
                "note": "the volatility risk premium (selling options) is a real, structurally-motivated (someone pays for insurance) source of return this repo has never touched, but with well-documented catastrophic tail risk (Volmageddon Feb 2018, -90%+ on a related inverse-vol product; COVID March 2020)",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "This repo has no options data of any kind, and options/vol-surface strategies are explicitly listed in sec 1's 'never tested at all' category - an infrastructure gap, not a research gap.",
        },
    },
    # ------------------------------------------------------------------ Tier 3
    {
        ...
        "hypotheses": [
            {
                "h": "b",
                "direction": "partially supports",
                "note": "cites 0.05-0.30% typical major-pair crypto slippage and recommends taker fee + 0.1-0.2% slippage as a conservative haircut - directionally close to, slightly above, this repo's own 4bps+1bp assumption, but unverifiable as a primary figure",
            },
        ],
        ...
        "red_flags": [
            "No stated methodology or data source for the 0.05-0.30% slippage figure - an unsupported number, exactly the Tier 3 pattern."
        ],
        "testable_with_repo_data": {
            "testable": False,
            "how": "Directional color only; not a source to size a cost-model change on.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "b",
                "direction": "partially supports",
                "note": "reports VIP-tier maker fees falling to 0% and taker fees to ~0.017% at the top futures tier, with a further 10% BNB discount - if directionally accurate, a large real-desk taker could pay well under this repo's assumed 4bps taker fee at high volume, though this repo's own cost assumption already approximates a non-VIP retail/small-institutional taker rate reasonably",
            },
        ],
        ...
        "red_flags": [
            "Third-party content-farm-style guide, not the primary exchange source - the specific bps figures should be verified against Binance's own current fee schedule before being used to justify any cost-model change."
        ],
        "testable_with_repo_data": {
            "testable": True,
            "how": "This repo's own crypto cost model (4bps taker + 1bp slippage) could be re-run at a lower, VIP-tier-consistent fee assumption as a sensitivity check - but only after verifying the fee schedule against a primary source, not this one.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "a",
                "direction": "supports",
                "note": "articulates the 'combine many weak, low-correlation signals' engineering-gap story qualitatively",
            },
        ],
        ...
        "red_flags": [
            "No costs, no track record, no out-of-sample evidence - a pure narrative/opinion piece."
        ],
        "testable_with_repo_data": {
            "testable": False,
            "how": "Not a specific, testable claim.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "a",
                "direction": "supports",
                "note": "if directionally true, illustrates an extreme version of the signal-combination engineering gap - but the specific number is unverifiable and should not be treated as established fact",
            },
        ],
        ...
        "red_flags": [
            "A suspiciously large, round-sounding number with no primary source or methodology - flagged explicitly rather than repeated as fact."
        ],
        "testable_with_repo_data": {
            "testable": False,
            "how": "Not independently verifiable or testable.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "a",
                "direction": "supports",
                "note": "even taking the popular account at face value, it describes an intensely engineered, high-frequency, many-signal system - consistent with hypothesis (a) directionally, but not usable as quantitative evidence",
            },
            {
                "h": "e",
                "direction": "supports",
                "note": "Medallion is explicitly closed to outside capital and has been for decades - the clearest possible illustration of sec 3.1's prior that reliably-profitable-at-scale strategies get walled off, not left available to be tested in a repo like this one",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "Not evidence of anything testable; included specifically as this survey's documented example of a Tier 3 claim correctly NOT elevated despite its fame and appeal.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "e",
                "direction": "supports",
                "note": "directional color that crowding/capacity is a live, widely-discussed industry concern, consistent with sec 3.1's 'hard, capacity-limited' prior",
            },
        ],
    ...
    },
    {
        ...
        "hypotheses": [
            {
                "h": "e",
                "direction": "partially supports",
                "note": "confirms the AS model is implementable in retail-accessible open-source tooling, lowering (but not eliminating) the infrastructure bar for a crypto market-making probe versus the colocated-HFT extreme",
            },
        ],
        ...
        "testable_with_repo_data": {
            "testable": False,
            "how": "This repo has OHLCV bar data only, no order-book/L2 depth - the strategy's own core risk (inventory vs. the book) cannot be simulated from bars alone, so even with open-source code available this remains untestable with the data this repo actually has.",
        },
    },
    {
        ...
        "hypotheses": [
            {
                "h": "b",
                "direction": "neutral",
                "note": "documents that intraday spreads peak ~2 hours after funding settlement and mid-tier exchanges sometimes lead Binance in price discovery - a real microstructure fact this repo's daily/hourly-bar strategies are too coarse to exploit or be materially hurt by",
            },
        ],
        ...
        "red_flags": [
            "MDPI journal-quality caveat noted explicitly rather than assumed away."
        ],
        "testable_with_repo_data": {
            "testable": False,
            "how": "Requires sub-hourly, cross-exchange, order-book-adjacent data this repo does not have.",
        },
    },
]
...
def summarize(sources):
    ...
    return {
        ...
        "gate_S_fires": (
            len(sources) >= 30 and all(v >= 5 for v in hyp_tier12.values())
        ),
    }
